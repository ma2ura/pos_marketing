...
アソシエーション分析の出力として、「ルール」とその有効性を表す3つの指標「支持度」、「確信度」、「リフト値」を見ます。

### 支持度

支持度は、全商品の購買数を$U$、ある商品$X$の購買数を$X$とした場合、$X$の支持度は

$$
\text{支持度} = \frac XU
$$

ある商品$X$と商品$Y$を両方購入した場合の割合は

$$
\text{支持度} = \frac {X \cap Y}U
$$
...
$X$と$Y$の両方を買った割合を確信度といい、

$$
\text{確信度} = \frac {X \cap Y}X
$$
